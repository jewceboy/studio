...
const categoryHotelsData: { [key: string]: { [key: string]: Hotel[] } } = {
  malaga: {
    luxury: [
      { id: 'malaga-lux-1', name: 'Gran Hotel Miramar GL', slug:'gran-hotel-miramar-gl', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "luxury hotel facade"), imageHint:"luxury hotel facade", description: 'Iconic 5-star luxury hotel offering stunning sea views and opulent amenities.', features: ['Beachfront', 'Outdoor Pool', 'Spa & Wellness Center', 'Fine Dining'], userScore: 9.2, priceGuide: '€€€€', affiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
      { id: 'malaga-lux-2', name: 'Vincci Selección Posada del Patio', slug:'vincci-seleccion-posada-del-patio', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "hotel rooftop pool"), imageHint:"hotel rooftop pool", description: 'Chic hotel with a unique rooftop pool and access to ancient city wall remains.', features: ['Rooftop Pool', 'Historic Site', 'Central Location', 'Modern Design'], userScore: 9.0, priceGuide: '€€€', affiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
    ],
    'family-friendly': [
      { id: 'malaga-fam-1', name: 'Ilunion Málaga', slug:'ilunion-malaga', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "family hotel pool"), imageHint:"family hotel pool", description: 'Modern hotel with spacious family rooms, near the port and train station.', features: ['Indoor Pool', 'Family Rooms', 'Near Attractions', 'Accessible'], userScore: 8.5, priceGuide: '€€', affiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
    ],
    beachfront: [
       { id: 'malaga-beach-1', name: 'Soho Boutique Las Vegas', slug:'soho-boutique-las-vegas', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "beach hotel malagueta"), imageHint:"beach hotel malagueta", description: 'Located on Malagueta Beach, offering sea views and an outdoor pool.', features: ['Direct Beach Access', 'Sea View Rooms', 'Outdoor Pool', 'Restaurant'], userScore: 8.3, priceGuide: '€€€', affiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
    ],
    boutique: [
       { id: 'malaga-boutique-1', name: 'Hotel Molina Lario', slug:'hotel-molina-lario', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "boutique hotel exterior"), imageHint:"boutique hotel exterior", description: 'Elegant boutique hotel in the city center with a rooftop pool and views of the cathedral.', features: ['Rooftop Pool', 'Cathedral Views', 'Central Location', 'Stylish Decor'], userScore: 8.9, priceGuide: '€€€', affiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
    ]
  },
  marbella: {
    '5-star-resorts': [
        { id: 'marbella-5star-1', name: 'Puente Romano Beach Resort', slug:'puente-romano-beach-resort', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "Marbella luxury resort"), imageHint:"Marbella luxury resort", description: 'A luxurious village-style resort on Marbella\'s Golden Mile.', features: ['Tennis Club', 'Multiple Restaurants', 'Botanical Gardens', 'Beach Access'], userScore: 9.3, priceGuide: '€€€€€', affiliateLink: `https://booking.com/marbella-hotels?aid=YOUR_AID` },
    ],
    'golf-hotels': [
        { id: 'marbella-golf-1', name: 'The Westin La Quinta Golf Resort & Spa', slug:'the-westin-la-quinta-golf', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "golf resort marbella"), imageHint:"golf resort marbella", description: 'Nestled in Golf Valley, offering a 27-hole course and serene spa.', features: ['27-hole Golf Course', 'Luxury Spa', 'Kids Club', 'Picturesque Setting'], userScore: 9.0, priceGuide: '€€€€', affiliateLink: `https://booking.com/marbella-hotels?aid=YOUR_AID` },
    ],
     'spa-hotels': [
        { id: 'marbella-spa-1', name: 'Anantara Villa Padierna Palace Benahavís Marbella Resort', slug:'anantara-villa-padierna-palace', imageUrl: PLACEHOLDER_IMAGE_URL(600,400, "spa resort marbella"), imageHint:"spa resort marbella", description: 'Tuscan-style palace resort with an award-winning spa and three golf courses.', features: ['Award-Winning Spa', 'Three Golf Courses', 'Roman Amphitheater', 'Art Collection'], userScore: 9.2, priceGuide: '€€€€€', affiliateLink: `https://booking.com/marbella-hotels?aid=YOUR_AID` },
    ]
  }
};
