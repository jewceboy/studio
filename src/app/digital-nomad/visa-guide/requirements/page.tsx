...
export const metadata = {
  title: 'Remote Work Spain Visa Requirements | Digital Nomad Guide',
  description: 'A checklist of all requirements for the Spanish remote work and digital nomad visa, including income, insurance, and background checks.',
};
