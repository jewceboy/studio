...
const articles: Pick<Article, 'title' | 'slug' | 'imageUrl' | 'imageHint' | 'excerpt' | 'date' | 'author' | 'categories'>[] = [
  { slug: 'best-tapas-malaga', title: 'Best Tapas Bars in Málaga Old Town', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'tapas food variety', excerpt: 'A culinary journey through Málaga\'s most authentic tapas spots, from traditional bites to modern creations.', date: '2024-05-15', author: 'Elena Rodriguez', categories: ['Food & Drink'] },
  { slug: 'hidden-beaches-costa-del-sol', title: 'Top 5 Hidden Beaches on the Costa del Sol', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'secluded cove beach', excerpt: 'Discover tranquil coves and pristine sands away from the crowds for a perfect day of relaxation.', date: '2024-05-10', author: 'Mark Stevenson', categories: ['Beaches', 'Travel Tips'] },
  { slug: 'day-trip-ronda', title: 'A Day Trip to Ronda: What to See and Do', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'Ronda bridge view', excerpt: 'Explore the dramatic landscapes, iconic bridge, and historic charm of the stunning town of Ronda.', date: '2024-05-01', author: 'Sofia Chen', categories: ['Day Trips'] },
  { slug: 'caminito-del-rey-guide', title: 'Ultimate Guide to Hiking Caminito del Rey', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'Caminito Rey path', excerpt: 'Everything you need to know before tackling one of Spain\'s most breathtaking hiking trails.', date: '2024-04-25', author: 'Carlos Gomez', categories: ['Adventure', 'Hiking'] },
  { slug: 'malaga-christmas-lights', title: 'Málaga Christmas Lights: A Festive Spectacle', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'Christmas lights street', excerpt: 'Experience the magic of Calle Larios adorned with spectacular Christmas lights and music.', date: '2023-12-01', author: 'Laura Schmidt', categories: ['Festivals', 'Malaga'] },
  { slug: 'andalusian-white-villages', title: 'Exploring the Charm of Andalusian White Villages', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: 'white village street', excerpt: 'A guide to the most picturesque "pueblos blancos" near Costa del Sol, rich in history and beauty.', date: '2024-03-18', author: 'David Miller', categories: ['Culture', 'Day Trips'] },
];
