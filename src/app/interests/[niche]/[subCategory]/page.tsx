...
const subCategoryData: { [key: string]: { [key: string]: { name: string; items: any[] } } } = {
  golf: {
    'best-courses': {
      ...
      items: [
        { id: 'gc1', name: 'Real Club Valderrama', slug: 'real-club-valderrama', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: "Valderrama golf", description: 'Legendary course, host of the Ryder Cup and Volvo Masters.', keyFeatures: [{label: 'Designer', value: 'Robert Trent Jones Sr.'}, {label: 'Difficulty', value: 'Very High'}], websiteUrl: 'https://www.valderrama.com/', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
        { id: 'gc2', name: 'Finca Cortesin Golf Club', slug: 'finca-cortesin-golf', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: "Finca Cortesin golf", description: 'Championship course known for its pristine condition and challenging layout.', keyFeatures: [{label: 'Designer', value: 'Cabell Robinson'}, {label: 'Difficulty', value: 'High'}], websiteUrl: 'https://www.fincacortesin.com/golf', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
        { id: 'gc3', name: 'La Reserva Club Sotogrande', slug: 'la-reserva-sotogrande', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: "Sotogrande golf", description: 'Exclusive club with a stunning course and luxurious amenities.', keyFeatures: [{label: 'Designer', value: 'Cabell Robinson'}, {label: 'Difficulty', value: 'High'}], websiteUrl: 'https://www.lareservaclubsotogrande.com/golf', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
      ] as GolfCourse[],
    },
    'golf-resorts': {
        name: 'Top Golf Resorts',
        items: [ // Assuming these are also GolfCourse type or a similar Resort type for consistency
             { id: 'gr1', name: 'Anantara Villa Padierna Palace Resort', slug:'anantara-padierna-resort', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint: "Anantara golf resort", description: 'Luxurious palace resort with three 18-hole golf courses.', keyFeatures: [{label: 'Courses', value: '3 x 18-hole'}, {label: 'Style', value: 'Luxury Palace'}], websiteUrl: '#', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
             { id: 'gr2', name: 'La Cala Resort', slug:'la-cala-resort', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint:"La Cala golf resort", description: 'Expansive resort featuring three championship courses and a golf academy.', keyFeatures: [{label: 'Courses', value: '3 Championship'}, {label: 'Amenities', value: 'Spa, Pools'}], websiteUrl: '#', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
        ] as GolfCourse[],
    },
     'marbella-golf': {
        name: 'Marbella Golf Guide',
        items: [
            { id: 'mg1', name: 'Marbella Golf & Country Club', slug: 'marbella-golf-country-club', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint:"Marbella country club", description: 'Designed by Robert Trent Jones Sr., offering challenging holes and sea views.', keyFeatures: [{label: 'Designer', value: 'Robert Trent Jones Sr.'}, {label: 'Views', value: 'Sea & Mountain'}], websiteUrl: '#', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
            { id: 'mg2', name: 'Santa Clara Golf Marbella', slug: 'santa-clara-golf-marbella', imageUrl: PLACEHOLDER_IMAGE_URL(600,400), imageHint:"Santa Clara golf", description: 'A well-regarded course suitable for various skill levels, close to Marbella center.', keyFeatures: [{label: 'Accessibility', value: 'Easy to reach'}, {label: 'Suits', value: 'All levels'}], websiteUrl: '#', nearbyHotelsAffiliateLink: BOOKING_COM_AFFILIATE_LINK_MALAGA_GENERAL },
        ] as GolfCourse[],
    }
  },
