...
export default function SeasonsPage() {
  return (
    <div>
      ...
      />
      <Section>
        <p className="text-center text-lg">Placeholder content for the Malaga seasons guide. This page will describe the atmosphere and activities for each season.</p>
      </Section>
    </div>
  );
}
